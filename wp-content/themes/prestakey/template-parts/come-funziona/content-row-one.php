...
<section class="row-one row-custom">
    <div class="col-12">
        <div class="slider">
            <div class="col-7">
                <h1 class="mb-5 mt-5 text-white"><strong>Prestakey:</strong> la soluzione che facilita <strong>l’accesso al credito</strong>, per privati e aziende.</h1>
            </div>
            <div class="col-8">
                ...
                <p class="fs-5">L’obiettivo è <strong>aiutare le imprese e i privati ad accedere al credito</strong> nella maniera più facile, efficiente e veloce possibile, riducendo il rischio di risposte negative da parte delle Banche.</p>
