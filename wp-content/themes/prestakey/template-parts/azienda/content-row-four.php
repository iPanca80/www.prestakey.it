    ...
    <div class="container">
        <div>
            <div class="col-12 d-flex justify-content-end">
                <h1 class="col-lg-8 col-12 mb-4 text-start"><?php echo $aziendaRow4Titolo ?></h1>
            </div>
            <div class="col-12 d-flex justify-content-end">
            ...
            <div class="col-12">
                <h2 class="col-12 text-start"><?php echo $aziendaRow4Titolo2 ?></h2>
                <div class="col-12">
                <?php get_template_part( '/template-parts/features' ); ?>
                </div>
            </div>
            <div class="col-12 d-flex justify-content-end">
                <h3 class="col-lg-8 col-12 mb-4 text-start"><?php echo $aziendaRow4Titolo3 ?></h3>
            </div>
            <div class="col-12 d-flex justify-content-end">
                <div class="col-lg-8 col-12 text-start">
                    <p class="col-12 mt-4 mb-1"><?php echo $aziendaRow4TitoloAsterisco ?></p>
                    <p class="col-12 lh-base"><?php echo $aziendaRow4DescrizioneAsterisco ?></p>  
                </div>
            </div>
        </div>
    </div>
