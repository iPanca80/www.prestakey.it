...
?>
<!-- Row 05 - start -->
<section class="row-five row-custom bg-shade desktop">
    <div class="container">
        <div>
            <div class="col-12">
...
<section class="row-five row-custom mobile">
    <div class="container">
        <div>
            <div class="col-12">
                <h1 class="col-lg-8 col-12 mb-4 "><?php echo $aziendaRow5Titolo ?></h1>
            </div>
            <div class="mb-4 mt-4 col-12 d-lg-flex">
            <div class="col-lg-6 col-12">
                <h3 class="col-12"><?php echo $aziendaRow5sottotitolo ?></h3>
            </div>
            <div class="col-lg-6 col-12 d-flex justify-content-end mt-4 mt-lg-0">
                <a href="/come-funziona/" class="cta-white">
                    <ul>
