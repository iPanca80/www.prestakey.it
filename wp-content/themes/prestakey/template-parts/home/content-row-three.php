    ...
    <div class="container">
        <div>
            ...
            <div class="col-8">
                ...
                <p class="col-12 mb-5 lh-base">Per farti la miglior proposta possibile, Prestaky ha bisogno di alcune informazioni sui conti delle banche che utilizzi. Ti chiederà, quindi, di condividere questi dettagli collegando i tuoi conti alla richiesta di finanziamento. Per farlo, ti basterà accedere al tuo internet banking durante il processo, basteranno pochi click. Grazie all’Open Banking, questi passaggi si svolgeranno nella massima sicurezza e nel pieno rispetto della tua privacy. In pochi minuti otterrai una risposta alla tua richiesta.</p>  
            </div>
        </div>
    </div>
</section>
